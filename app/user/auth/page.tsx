  ...
  return (
    <div className="relative">
      <Image
        ...
        width={1920}
      />
      <div className="w-full h-[90vh] bg-gradient-to-t from-black absolute top-0 flex items-center justify-center">
        <Card>
          ...
          <CardContent>
            <Tabs defaultValue="login" className="w-[400px]">
              ...
              <TabsContent value="register">
                <div className="flex flex-col items-center text-center mt-8">
                  <h1 className="text-2xl font-bold">Welcome to TiKit</h1>
                  <p className="text-balance text-muted-foreground">
                    Create a new TiKit account
                  </p>
                </div>
                <Form {...registerForm}>
                  <form
